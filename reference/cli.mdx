---
title: "CLI reference for kermit_model_evaluation.py"
sidebarTitle: "CLI"
description: "Complete CLI reference for kermit_model_evaluation.py including all flags, input types, output behavior, and example invocations."
---
