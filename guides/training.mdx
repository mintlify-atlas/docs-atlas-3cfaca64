---
title: "Train the Kermit detection model with ImageAI"
sidebarTitle: "Training"
description: "Train a ResNet-based binary classifier using ImageAI's ModelTraining API to detect Kermit from The Muppets in images."
---
